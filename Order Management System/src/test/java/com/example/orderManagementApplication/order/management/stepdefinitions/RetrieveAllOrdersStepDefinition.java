...
public class RetrieveAllOrdersStepDefinition {
    private RestTemplate restTemplate = new RestTemplate();
    private ResponseEntity<String> response;
    private final String RETRIEVE_ORDER_SERVICE_BASE_URL = "http://localhost:8082/orders";

    @When("I request to retrieve all orders")
    public void requestToRetrieveAllOrders() {
        response = restTemplate.getForEntity(RETRIEVE_ORDER_SERVICE_BASE_URL + "/retrieve-orders", String.class);
    }
